"""
Django settings for NousDA project.
...
ALLOWED_HOSTS = ['35.237.53.200','localhost'] # this si teh allowed 35.237.191.34
...
WSGI_APPLICATION = 'NousDA.wsgi.application'
